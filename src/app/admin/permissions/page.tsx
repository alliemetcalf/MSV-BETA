...
const permissionsData: Permission[] = [
  ...
  { page: 'Door Codes', path: '/door-codes', superadmin: 'read/write', manager: 'read/write', contractor: 'read', user: 'none' },
  { page: 'Tenants', path: '/tenants', superadmin: 'read/write', manager: 'read/write', contractor: 'read', user: 'none' },
  { page: 'Properties', path: '/properties', superadmin: 'read/write', manager: 'read/write', contractor: 'read', user: 'read' },
  { page: 'Rooms', path: '/rooms', superadmin: 'read/write', manager: 'read/write', contractor: 'read', user: 'read' },
  ...
  { page: 'Tasks', path: '/tasks', superadmin: 'read/write', manager: 'read/write', contractor: 'read/write', user: 'none' },
